...
//        select.selectByVisibleText(color);
    ...
    public SelectMenuPage verifyColor() {
        String firsSelectedOption  = new Select(oldSelectMenu).getFirstSelectedOption().getText();
        Assertions.assertTrue(shouldHaveText(oldSelectMenu,firsSelectedOption,5));
        return this;
    }
