...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage typeOfData(String data) {
        clickWithJS(dateOfBirthInput, 0, 500);
    ...
    public PracticeFormPage selectDate(String month, String year, String date) {
        ...
        driver.findElement(By.xpath("//*[@class='react-datepicker__week']//div[.='" + date + "']")).click();        return this;
    }
}
